...
- nationality: the nationality or country of origin that the NAME most suggests -- a guess about the name's linguistic origin, not a claim about the person. One adjective, e.g. "American", "Turkish", "Italian". Most of this list reads as generic English-language names: use "American" for those. Use "unknown" when the entry is only initials, digits or a nickname.
